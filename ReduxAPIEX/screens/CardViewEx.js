...
const styles = StyleSheet.create({
  linetxt: { 
    ...
    SectionStyle: {
        ...
        backgroundColor: '#FAFDFC', borderColor: '#57585C', height: 50, width:340,
         marginTop:30, color: '#000', borderRadius:10,marginRight:10,marginLeft:10,
    },  
    card: {
        marginHorizontal: 10,
        padding: 10,
